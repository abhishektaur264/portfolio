...
import { Sparkles, ArrowRight, Terminal, Shield, Activity, FileText, Mail, Github, Linkedin, Check, Phone, Code2 } from 'lucide-react';
...
const Hero = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("abhishektaur7@gmail.com");
    setCopied(true);
        ...
        <div className="lg:col-span-7 space-y-10">
          <div className="space-y-4">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-7xl md:text-[9.5rem] font-black leading-[0.8] tracking-tighter text-white uppercase italic">
              ABHISHEK <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/80 to-white/20 not-italic">TAUR</span>
            </motion.h1>
          </div>
          ...
          <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} className="relative w-full max-w-[420px] aspect-[4/5] group">
            ...
            <div className="absolute inset-0 rounded-[3.5rem] bg-[#0a0a0a] border border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.6)] backdrop-blur-3xl overflow-hidden p-8 flex flex-col justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                 ...
                 {/* GitHub */}
                 <a href="https://github.com/abhishektaur264" target="_blank" rel="noreferrer" className="group p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors flex items-center gap-3">
                 ...
                 {/* LinkedIn */}
                 <a href="https://www.linkedin.com/in/abhishek-taur" target="_blank" rel="noreferrer" className="group p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors flex items-center gap-3">
                 ...
                 {/* LeetCode */}
                 <a href="https://leetcode.com/u/abhishektaur/" target="_blank" rel="noreferrer" className="group p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors flex items-center gap-3">
                    <div className="p-1.5 bg-yellow-500/20 rounded-lg text-yellow-500 group-hover:text-yellow-400">
                       <Code2 size={14} />
                    </div>
                    <div className="flex flex-col">
                       <span className="text-[8px] font-mono text-gray-500 uppercase">Solve</span>
                       <span className="text-[9px] font-bold text-white uppercase tracking-wider">LeetCode</span>
                    </div>
                 </a>

                 {/* Phone */}
                 <a href="tel:+917758893173" className="group p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors flex items-center gap-3">
                    <div className="p-1.5 bg-green-500/20 rounded-lg text-green-500 group-hover:text-green-400">
                       <Phone size={14} />
                    </div>
                    <div className="flex flex-col">
                       <span className="text-[8px] font-mono text-gray-500 uppercase">Call</span>
                       <span className="text-[9px] font-bold text-white uppercase tracking-wider">Phone</span>
                    </div>
                 </a>
              </div>
