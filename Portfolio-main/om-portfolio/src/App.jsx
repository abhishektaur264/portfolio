...
const GITHUB_USERNAME = "abhishektaur264";
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
            ...
            <div className="space-y-6">
               ...
               <div className="pt-4">
                 <a href="mailto:abhishektaur7@gmail.com" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black rounded-full font-bold uppercase tracking-widest hover:scale-105 transition-transform shadow-[0_0_20px_rgba(255,255,255,0.3)]">
            ...
            <div className="flex flex-col gap-6 items-start md:items-end min-w-[200px]">
               <a href="https://www.linkedin.com/in/abhishek-taur" target="_blank" rel="noreferrer" className="group flex items-center gap-3 text-xl font-bold text-gray-400 hover:text-white transition-colors">
                  LinkedIn <ArrowUpRight size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
               </a>
               <a href="https://github.com/abhishektaur264" target="_blank" rel="noreferrer" className="group flex items-center gap-3 text-xl font-bold text-gray-400 hover:text-white transition-colors">
                  GitHub <ArrowUpRight size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
               </a>
               <a href="https://leetcode.com/u/abhishektaur/" target="_blank" rel="noreferrer" className="group flex items-center gap-3 text-xl font-bold text-gray-400 hover:text-white transition-colors">
                  LeetCode <ArrowUpRight size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
               </a>
               <a href="mailto:abhishektaur7@gmail.com" className="group flex items-center gap-3 text-xl font-bold text-gray-400 hover:text-white transition-colors">
                  Email <ArrowUpRight size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
               </a>
               <a href="tel:+917758893173" className="group flex items-center gap-3 text-xl font-bold text-gray-400 hover:text-white transition-colors">
                  +91 7758893173 <ArrowUpRight size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
               </a>
          ...
          <div className="mt-24 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-mono text-gray-600 uppercase tracking-[0.2em]">
             <span>© 2026 Abhishek Taur. All Rights Reserved.</span>
