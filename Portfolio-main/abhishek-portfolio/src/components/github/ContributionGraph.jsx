  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const profileRes = await fetch('https://api.github.com/users/abhishektaur264');
        const profileData = await profileRes.json();
        
        const contribRes = await fetch('https://github-contributions-api.jogruber.de/v4/abhishektaur264');
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center py-8">
      ...
      <div className="w-full overflow-hidden rounded-xl bg-white/5 border border-white/10 p-4 mb-8">
        <img 
          src="https://ghchart.rshah.org/22c55e/abhishektaur264" 
