...
import { Home, User, Layers, Github, Linkedin, Mail, Check, Award, Download, Code2 } from 'lucide-react';
...
const FloatingNav = () => {
  ...
  const socialLinks = [
    { id: 'github', icon: Github, href: 'https://github.com/abhishektaur264' },
    { id: 'linkedin', icon: Linkedin, href: 'https://www.linkedin.com/in/abhishek-taur' },
    { id: 'leetcode', icon: Code2, href: 'https://leetcode.com/u/abhishektaur/' },
  ];
