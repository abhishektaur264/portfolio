    ...
    <section id="about" className="py-24 px-6 max-w-7xl mx-auto scroll-mt-20">
      ...
      >
        ...
        <h3 className="text-4xl md:text-5xl font-black text-white tracking-tighter italic uppercase">
          A developer who builds the systems, <br /> then checks how they can be broken.
        </h3>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div className="z-10">
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-lg">
              I build scalable web applications leveraging the <strong>MERN Stack</strong> (MongoDB, Express, React, Node.js) and robust enterprise backends using <strong>Spring Boot</strong>.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-tight">Languages</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Proficient in <strong>Java</strong>, <strong>Python</strong>, <strong>JavaScript</strong>, as well as <strong>HTML5</strong> and <strong>CSS3</strong>.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-lg font-bold text-white uppercase tracking-tight">Databases</h3>
          </div>
          <p className="text-gray-400 text-sm">
             Proficient in relational <strong>MySQL (SQL)</strong> and NoSQL <strong>MongoDB</strong> architecture.
          </p>
        </motion.div>
        ...
        >
           <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-lg font-bold text-white uppercase tracking-tight">Cloud & Infra</h3>
          </div>
          <p className="text-gray-400 text-sm">
            Deploying and containerizing applications using <strong>AWS</strong>, <strong>Docker</strong>, and <strong>Vercel</strong>.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 text-sm">
            Streamlining development with <strong>Git/GitHub</strong>, <strong>Postman</strong>, and designing in <strong>Figma</strong>.
          </p>
        </motion.div>
        ...
        >
          <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
             ...
             <div>
                <h3 className="text-xl font-bold text-white italic tracking-tight">"Systems built to last."</h3>
                <p className="text-gray-500 text-sm mt-1">
                   Leveraging <strong>Java/Python</strong> for backend solutions and <strong>React.js</strong> for dynamic application development.
                </p>
             </div>
          </div>
